...
export function enoughEthBalance(nodeStatus?: NodeStatus, networkRplPrice?: NetworkRplPrice) {
    ...
    const ethBalance = 16200000000000000000; // nodeStatus?.accountBalances.eth ?? 0;
    const rplBalance = 68000000000000000000; // nodeStatus?.accountBalances.rpl ?? 0;
